## [2267.检查是否有合法括号字符串路径 中文热门题解1](https://leetcode.cn/problems/check-if-there-is-a-valid-parentheses-string-path/solutions/100000/tian-jia-zhuang-tai-hou-dfscpythonjavago-f287)
