## [2787.将一个数字表示成幂的和的方案数 中文热门题解1](https://leetcode.cn/problems/ways-to-express-an-integer-as-sum-of-powers/solutions/100000/0-1-bei-bao-mo-ban-ti-by-endlesscheng-ap09)
