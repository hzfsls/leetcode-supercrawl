## [2571.将整数减少到零需要的最少操作数 中文热门题解1](https://leetcode.cn/problems/minimum-operations-to-reduce-an-integer-to-0/solutions/100000/ji-yi-hua-sou-suo-by-endlesscheng-cm6l)
