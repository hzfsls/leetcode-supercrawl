## [2654.使数组所有元素变成 1 的最少操作次数 中文热门题解1](https://leetcode.cn/problems/minimum-number-of-operations-to-make-all-array-elements-equal-to-1/solutions/100000/liang-chong-fang-fa-bao-li-mei-ju-li-yon-refp)
