## [467.环绕字符串中唯一的子字符串 中文热门题解1](https://leetcode.cn/problems/unique-substrings-in-wraparound-string/solutions/100000/xi-fa-dai-ni-xue-suan-fa-yi-ci-gao-ding-qian-zhui-)
...
![](https://pic.leetcode-cn.com/1601445772-hXPzFo-007S8ZIlly1gj6m27kgbsj306u06gt8u.jpg)
...
![](https://pic.leetcode-cn.com/1601445772-HBnbiX-007S8ZIlly1gj8m692laxj30pz0grte9.jpg)
...
![](https://pic.leetcode-cn.com/1601445772-LpDXlN-007S8ZIlly1gj8k7w0bqyj30qh07540b.jpg)

一种思路就是在 i 的位置 + k， 然后利用前缀和的技巧给 i 到 n 的元素都加上 k。但是题目需要加的是一个区间， j + 1 及其之后的元素会被多加一个 k。一个简单的技巧就是给 j + 1 的元素减去 k，这样正负就可以抵消。

![](https://pic.leetcode-cn.com/1601445772-AroFIz-007S8ZIlly1gj8k997nmbj30q9074dhm.jpg)
