## [146.LRU 缓存 中文热门题解1](https://leetcode.cn/problems/lru-cache/solutions/100000/lru-ce-lue-xiang-jie-he-shi-xian-by-labuladong)
...
![](https://pic.leetcode-cn.com/1647580694-LOetlT-1.jpg){:width=450}{:align=center}

但是这时候如果我访问了一下「设置」界面，那么「设置」就会被提前到第一个，变成这样：

![](https://pic.leetcode-cn.com/1647580694-fbVlMc-2.jpg){:width=450}{:align=center}

假设我的手机只允许我同时开 3 个应用程序，现在已经满了。那么如果我新开了一个应用「时钟」，就必须关闭一个应用为「时钟」腾出一个位置，关那个呢？

按照 LRU 的策略，就关最底下的「手机管家」，因为那是最久未使用的，然后把新开的应用放到最上面：

![](https://pic.leetcode-cn.com/1647580694-xIevJm-3.jpg){:width=450}{:align=center}
...
![](https://pic.leetcode-cn.com/1647580694-NAtygG-4.jpg)
...
* [手把手带你实现 LFU 算法](https://labuladong.gitee.io/plugin-v4/?qno=460)
