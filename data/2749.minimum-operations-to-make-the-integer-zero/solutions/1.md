## [2749.得到整数零需要执行的最少操作数 中文热门题解1](https://leetcode.cn/problems/minimum-operations-to-make-the-integer-zero/solutions/100000/mei-ju-da-an-pythonjavacgo-by-endlessche-t4co)
