## [2602.使数组元素全部相等的最少操作次数 中文热门题解1](https://leetcode.cn/problems/minimum-operations-to-make-all-array-elements-equal/solutions/100000/yi-tu-miao-dong-pai-xu-qian-zhui-he-er-f-nf55)
